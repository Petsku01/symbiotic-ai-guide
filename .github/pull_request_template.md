...
- [ ] Artifact hygiene checked (`.gitignore` updated as needed; no local runtime artifacts like `pilot-results.jsonl` committed)
- [ ] Metadata is consistent (validation date/version markers and command examples align across docs)
